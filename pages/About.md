...
# Recent Projects
Last year I built a wood-fired sauna in Mount Hood National Forest. [This](https://slowlywilliam.com/saunabuild/) is a detailed journal I made about its construction.

I’ve always got a bunch of side projects bubbling. Some recent ones include a [used EV price tracker](https://slowlywilliam.com/usedevpricetracker/) (and a [CarPlay voice assistant](https://okev.dad) that helps you find a nearby charger), an [open source Instapaper client](https://github.com/quicklywilliam/ereader) for Kindle and Kobo ereaders (and a virtual [Kobo page turner](https://github.com/quicklywilliam/KoboWatchRemote) that uses your Apple Watch).

[Ride Report](https://www.ridereport.com) - Ride Report is a software platform that helps cities launch and evaluate bike, scooter and car sharing programs. It was my second company, started with [Evan Heidtmann](https://github.com/ezheidtmann) and acquired by Inrix. It was born from my passion for urban transportation systems, and I worked hard to grow it according to my values. I’m especially proud of our [Employee Handbook](https://ridereport.notion.site/Ride-Report-Employee-Guide-07f5888e232d49daacca58d599cd09f9).
